...
import { getAdminTechnologies } from "@/lib/cms/queries";
import { apiDelete } from "@/lib/api/cms";
export default async function TechnologiesListPage() {
              ...
              <tr key={item.id} className="hover:bg-slate-50">
                ...
                <td className="px-4 py-3">
                  <div className="flex items-center gap-2">
                    ...
                    <form action={async () => { await apiDelete("/cms/technologies/" + item.id); }}>
